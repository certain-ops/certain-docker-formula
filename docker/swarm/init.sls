...
# Is manager: {{ if salt['match.{}'.format(docker.manager_target_type)](docker.manager_target) }}
# Is worker: {{ if salt['match.{}'.format(docker.worker_target_type)](docker.worker_target) }}
